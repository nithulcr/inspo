      ...
      <section className="py-14 lg:py-20    mt-[70] lg:mt-[100px] service-section relative">
        ...
        <div className="max-w-[1320px] mx-auto px-6  grid lg:grid-cols-3 z-1 gap-6 relative">
          <div className='flex flex-col gap-6 lg:gap-12 lg:col-span-2'>
            <div>
              <h1 className='text-3xl lg:text-[36px] xl:text-[48px] font-bold mb-1 leading-tight max-w-[600px] mb-2'>Website & App Development Services in UAE</h1>
              <p className='max-w-[420px]'>Professional website, web application, and mobile app development solutions for modern businesses.</p>
            </div>
            <Image
              src="/web-application.jpg"
            ...
            <div className='flex flex-col gap-8 md:gap-12'>
              <div>
                <h5 className='font-semibold mb-4 text-xl md:text-2xl'>Custom Website and Application Development for UAE Businesses</h5>
                <div className='text-[#A7A9AC] flex flex-col gap-4'>
                <p>A professional website or application helps your business build trust, attract customers, and manage operations more efficiently in today’s digital market.</p>
                  <p>At INSPO Businessmen Services LLC, we provide website development, web application development, mobile-friendly designs, e-commerce solutions, UI/UX planning, and ongoing technical support for startups, SMEs, and growing companies across the UAE. Our team focuses on clean design, smooth performance, secure development, and user-friendly digital solutions tailored to your business goals.</p>
                </div>
              ...
              <div className='flex flex-col gap-6'>
                <div className='mb-5'>
                  <h5 className='font-semibold mb-4 text-xl md:text-2xl'>Driving Results with Modern, Scalable Web App Solutions</h5>

                  <p className='text-[#A7A9AC]'>Turning ideas into reality is the core mission, delivering fast, reliable web applications through an agile approach that adapts to evolving business requirements. A seasoned team engineers custom web solutions that tackle unique industry challenges with precision, ensuring efficiency, scalability, and long-term maintainability.</p>
                ...
                <div>
                  ...
                  <div className='grid md:grid-cols-2 gap-6'>
                    <div className='flex gap-2 text-sm '>
                      {CheckmarkIcon}
                      <div>
                        <h5 className='text-xl font-medium mb-1'>Business Website Development</h5>
                        <p className='text-[#A7A9AC]'>Professional websites designed to showcase your company, services, and brand identity.</p>
                      </div>
                    </div>
                    ...
                    <div className='flex gap-2 text-sm '>
                      {CheckmarkIcon}
                      <div>
                        <h5 className='text-xl font-medium mb-1'>Custom Web Application</h5>
                        <p className='text-[#A7A9AC]'>Tailored web applications to manage business processes, customers, bookings, and operations.</p>
                      </div>
                    </div>
                    ...
                    <div className='flex gap-2 text-sm '>
                      {CheckmarkIcon}
                      <div>
                        <h5 className='text-xl font-medium mb-1'>Mobile App Development</h5>
                        <p className='text-[#A7A9AC]'>User-friendly mobile app solutions for businesses that need Android and iOS applications.</p>
                      </div>
                    </div>
                    ...
                    <div className='flex gap-2 text-sm '>
                      {CheckmarkIcon}
                      <div>
                        <h5 className='text-xl font-medium mb-1'>E-Commerce Development</h5>
                        <p className='text-[#A7A9AC]'>Online store development with product pages, checkout flow, and payment gateway support.</p>
                      </div>
                    </div>
                    ...
                    <div className='flex gap-2 text-sm '>
                      {CheckmarkIcon}
                      <div>
                        <h5 className='text-xl font-medium mb-1'>UI/UX Design</h5>
                        <p className='text-[#A7A9AC]'>Clean, modern, and user-friendly interface design for better customer experience.</p>
                      </div>
                    </div>
                    ...
                    <div className='flex gap-2 text-sm '>
                      {CheckmarkIcon}
                      <div>
                        <h5 className='text-xl font-medium mb-1'>Website Maintenance</h5>
                        <p className='text-[#A7A9AC]'>Ongoing support for updates, improvements, security checks, and performance optimization.</p>
                      </div>
                    </div>
                    ...
                    <div className='flex gap-2 text-sm '>
                      {CheckmarkIcon}
                      <div>
                        <h5 className='text-xl font-medium mb-1'>SEO-Friendly Website Setup</h5>
                        <p className='text-[#A7A9AC]'>Website structure and basic SEO setup to improve visibility on search engines.</p>
                      </div>
                    </div>
                    ...
                    <div className='flex gap-2 text-sm '>
                      {CheckmarkIcon}
                      <div>
                        <h5 className='text-xl font-medium mb-1'>Domain, Hosting & Email Support</h5>
                        <p className='text-[#A7A9AC]'>Assistance with domain registration, hosting setup, business email, and technical configuration.</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className='lg:p-10 p-5 text-white bg-[var(--blue)] rounded-xl grid md:grid-cols-2 gap-6'>
                  <div>
                    <h4 className=' text-xl max-w-[360px]'>Need a website or App for Your Business?</h4>
                    <p className='text-sm pt-1'>Call us today for professional website and application development support.</p>
                  </div>
                  ...
                  <li className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                      <span className="text-[14px]">Get Web Development Support</span>
