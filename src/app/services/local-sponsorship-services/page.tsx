...
export default function LocalSponsorshipNomineeServices() {
  return (
    <>
      <Header />
      <section className="py-14 lg:py-20    mt-[70] lg:mt-[100px] service-section relative">
        ...
        <div className="max-w-[1320px] mx-auto px-6  grid lg:grid-cols-3 z-1 gap-6 relative">
          <div className='flex flex-col gap-6 lg:gap-12 lg:col-span-2'>
            <div>
              <h1 className='text-3xl lg:text-[36px] xl:text-[48px] font-bold mb-1 leading-tight max-w-[600px] mb-2'>Local Sponsorship & Nominee Services in UAE
              </h1>
              <p className='max-w-[420px]'>Reliable local sponsorship and nominee support for UAE mainland business setup and compliance.</p>
            </div>
            <Image
              src="/local-sponsorship.png"
            ...
            <div className='flex flex-col gap-8 md:gap-12'>
              <div>
                <h5 className='font-semibold mb-5 text-xl md:text-2xl'>Trusted Local Sponsorship Support for UAE Mainland Companies</h5>
                <div className='text-[#A7A9AC] flex flex-col gap-4'>
                  <p>Local sponsorship and nominee services can support certain UAE mainland business structures where a UAE national partner, local service agent, or nominee arrangement may be required based on the business activity and legal structure.</p>
                  <p>At INSPO Businessmen Services LLC, we assist entrepreneurs, investors, and companies with professional local sponsorship and nominee service support across the UAE. Our team helps with sponsor coordination, agreement preparation, documentation, licensing support, and compliance guidance to ensure a smooth and transparent business setup process.</p>
                </div>
              ...
              <div>
                {/* <h5 className='font-semibold mb-7 text-xl md:text-2xl'>Benefits</h5> */}
                <div className='grid md:grid-cols-2 gap-6'>
                  <div className='flex gap-2 text-sm'>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Mainland Business Support</h5>
                      <p className='text-[#A7A9AC]'>
                        Assistance for businesses that require UAE mainland sponsorship or local service agent support.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm'>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Trusted Sponsor Coordination</h5>
                      <p className='text-[#A7A9AC]'>
                        Professional coordination with reliable local sponsors and nominee partners.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm'>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Clear Agreement Preparation</h5>
                      <p className='text-[#A7A9AC]'>
                        Support with structured agreements to define roles, responsibilities, and business terms.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm'>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Licensing Assistance</h5>
                      <p className='text-[#A7A9AC]'>
                        Guidance for trade license applications, renewals, amendments, and government approvals.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm'>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Compliance Guidance</h5>
                      <p className='text-[#A7A9AC]'>
                        Helping your business meet UAE legal, regulatory, and documentation requirements.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm'>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Smooth Government Processing</h5>
                      <p className='text-[#A7A9AC]'>
                        Support with government coordination, application follow-up, and official submissions.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm'>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Ownership Structure Guidance</h5>
                      <p className='text-[#A7A9AC]'>
                        Clear guidance on suitable company structures based on your activity and requirements.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm'>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Business Continuity Support</h5>
                      <p className='text-[#A7A9AC]'>
                        Ongoing support for renewals, updates, and related business administration needs.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className='lg:p-10 p-5 text-white bg-[var(--blue)] rounded-xl grid md:grid-cols-2 gap-6'>
                <div>
                  <h4 className=' text-xl max-w-[360px]'>Need Local Sponsorship Support?</h4>
                  <p className='text-sm pt-1'>Call us today for reliable UAE mainland sponsorship and nominee service assistance.</p>
                </div>
                ...
                <li className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    <span className="text-[14px]">Get Sponsorship Support</span>
