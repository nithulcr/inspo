      ...
      <section className="py-14 lg:py-20    mt-[70] lg:mt-[100px] service-section relative">
        ...
        <div className="max-w-[1320px] mx-auto px-6  grid lg:grid-cols-3 z-1 gap-6 relative">
          <div className='flex flex-col gap-6 lg:gap-12 lg:col-span-2'>
            <div>
              <h1 className='text-3xl lg:text-[36px] xl:text-[48px] font-bold mb-1 leading-tight max-w-[500px] mb-2'>Digital Marketing Services in UAE</h1>
              <p className='max-w-[450px]'>Strategic digital marketing solutions to increase brand visibility, attract customers, and grow your business online.</p>
            </div>
            <Image
            ...
            <div className='flex flex-col gap-8 md:gap-12'>
              <div>
                <h5 className='font-semibold mb-5 text-xl md:text-2xl'>Creative and Result-Focused Marketing Solutions for UAE Businesses</h5>
                <div className='text-[#A7A9AC] flex flex-col gap-4'>
               <p>
                A strong digital presence is essential for every business to build trust, reach the right audience, and generate quality enquiries in today’s competitive market.
               </p>
                <p>At INSPO Businessmen Services LLC, we provide professional digital marketing support for startups, SMEs, and growing companies across the UAE. Our services include social media marketing, content creation, branding support, SEO guidance, Google Business Profile optimization, paid ads support, and lead generation strategies to help your business grow online with confidence.</p>
                </div>
  ...
  <div>
                ...
                <div className='grid md:grid-cols-2 gap-6'>
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Social Media Marketing</h5>
                      <p className='text-[#A7A9AC]'>Professional marketing support for Instagram, Facebook, LinkedIn, and other digital platforms.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Content Creation</h5>
                      <p className='text-[#A7A9AC]'>Creative posts, captions, promotional content, and brand-focused marketing materials.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>SEO Support</h5>
                      <p className='text-[#A7A9AC]'>Keyword and website guidance to improve your business visibility on search engines.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Google Business Profile</h5>
                      <p className='text-[#A7A9AC]'>Setup and optimization support to help customers find your business on Google.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Paid Ads Support</h5>
                      <p className='text-[#A7A9AC]'>Guidance for Google Ads and social media ads to reach targeted customers.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Lead Generation</h5>
                      <p className='text-[#A7A9AC]'>Marketing strategies designed to attract quality enquiries and potential customers.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Branding Support</h5>
                      <p className='text-[#A7A9AC]'>Assistance with brand messaging, visual identity, and professional business presentation.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Marketing Strategy</h5>
                      <p className='text-[#A7A9AC]'>Clear marketing planning based on your business goals, target audience, and services.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className='lg:p-10 p-5 text-white bg-[var(--blue)] rounded-xl grid md:grid-cols-2 gap-6'>
                <div>
                  <h4 className=' text-xl max-w-[360px]'>Need Digital Marketing Support?</h4>
                <p className='text-sm pt-1'>Call us today to grow your business online with professional marketing solutions.</p>
                </div>
                ...
                <li className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    <span className="text-[14px]">Get Marketing Support</span>
