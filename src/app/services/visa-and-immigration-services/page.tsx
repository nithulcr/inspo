      ...
      <section className="py-14 lg:py-20    mt-[70] lg:mt-[100px] service-section relative">
        ...
        <div className="max-w-[1320px] mx-auto px-6  grid lg:grid-cols-3 z-1 gap-6 relative">
          <div className='flex flex-col gap-6 lg:gap-12 lg:col-span-2'>
            <div>
              <h1 className='text-3xl lg:text-[36px] xl:text-[48px] font-bold mb-1 leading-tight max-w-[500px] mb-2'>Visa & Immigration Services in UAE</h1>
              <p className='max-w-[500px]'>Complete visa support for investors, employees, families, tourists, and business owners in the UAE.</p>
            </div>
            <Image
              src="/visa.jpg"
            ...
            <div className='flex flex-col gap-8 md:gap-12'>
              <div>
                <h5 className='font-semibold mb-5 text-xl md:text-2xl'>Professional UAE Visa & Immigration Support</h5>
                <div className='text-[#A7A9AC] flex flex-col gap-4'>
                  <p>
                    At INSPO Businessmen Services LLC, we provide end-to-end visa and immigration support for individuals, families, employees, investors, and business owners in the UAE.
                  </p>
                  <p>Our team assists with visit visas, employment visas, investor visas, family visas, Emirates ID, medical fitness, visa renewals, status change, and immigration documentation. We help you complete the process smoothly, accurately, and on time.</p>
                </div>

              </div>
              <div>
                <h5 className='font-semibold mb-7 text-xl md:text-2xl'>What do we offer?</h5>
                <div className='grid md:grid-cols-2 gap-6'>
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Visit Visa Assistance</h5>
                      <p className='text-[#A7A9AC]'>Support for UAE visit visa applications, extensions, and status change.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Employment Visa</h5>
                      <p className='text-[#A7A9AC]'>Complete assistance for employee visa processing, medical, Emirates ID, and stamping.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Investor & Partner Visa</h5>
                      <p className='text-[#A7A9AC]'>Visa support for business owners, investors, partners, and company shareholders.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Family Visa</h5>
                      <p className='text-[#A7A9AC]'>Assistance with spouse, children, and dependent visa applications.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Golden Visa Assistance</h5>
                      <p className='text-[#A7A9AC]'>Professional guidance for eligible investors, professionals, and special categories.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Maid Visa</h5>
                      <p className='text-[#A7A9AC]'>Support for domestic worker visa applications, renewals, and documentation.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Visa Renewal & Cancellation</h5>
                      <p className='text-[#A7A9AC]'>Assistance with visa renewal, cancellation, and immigration file updates.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Emirates ID & Medical Support</h5>
                      <p className='text-[#A7A9AC]'>Guidance for Emirates ID application, biometric, and medical fitness procedures.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className='lg:p-10 p-5 text-white bg-[var(--blue)] rounded-xl grid md:grid-cols-2 gap-6'>
                <div>
                  <h4 className=' text-xl max-w-[360px]'>Need Visa & Immigration Support?</h4>
                <p className='text-sm pt-1'>Call us today for fast and reliable assistance.</p>
                </div>
                ...
                <li className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    <span className="text-[14px]">Get Visa Support</span>
          ...
          <div className='lg:col-span-1'>
            <div className='max-w-[500px] mx-auto'>
              <ServiceTabs current="/services/visa-and-immigration-services" />
            </div>
          </div>
