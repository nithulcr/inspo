      ...
      <section className="py-14 lg:py-20    mt-[70] lg:mt-[100px] service-section relative">
        ...
        <div className="max-w-[1320px] mx-auto px-6  grid lg:grid-cols-3 z-1 gap-6 relative">
          <div className='flex flex-col gap-6 lg:gap-12 lg:col-span-2'>
            <div>
              <h1 className='text-3xl lg:text-[36px] xl:text-[48px] font-bold mb-1 leading-tight max-w-[600px] mb-2'>Corporate Bank Account Opening Support in UAE</h1>
            ...
            <div className='flex flex-col gap-6 lg:gap-12'>
              <div>
                <h5 className='font-semibold mb-5 text-xl md:text-2xl'>UAE Bank Account Opening for Businesses and Entrepreneurs</h5>
                <div className='text-[#A7A9AC] flex flex-col gap-4'>
                  <p>Opening a corporate bank account in the UAE is an important step after company formation. Banks require proper documentation, KYC details, business activity information, and compliance checks before account approval.</p>
                  <p>At INSPO Businessmen Services LLC, we assist businesses with bank selection, document preparation, application support, and coordination with banking partners. Our team helps make the process clear, organized, and compliant, giving entrepreneurs a smoother banking experience in the UAE.</p>
                </div>
              ...
              <div>
                ...
                <div className='grid md:grid-cols-2 gap-6'>
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Corporate Bank Account Support</h5>
                      <p className='text-[#A7A9AC]'>Assistance with opening business bank accounts for UAE mainland and free zone companies.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Personal Bank Account Support</h5>
                      <p className='text-[#A7A9AC]'>Guidance for residents, investors, and professionals applying for personal bank accounts.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Bank Selection Guidance</h5>
                      <p className='text-[#A7A9AC]'>Helping you choose suitable banking options based on your company activity and requirements.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>KYC Documentation Support</h5>
                      <p className='text-[#A7A9AC]'>Preparation of required documents for bank compliance and verification.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Application Follow-Up</h5>
                      <p className='text-[#A7A9AC]'>Coordination and follow-up with banking representatives for smooth processing.</p>
                    </div>
                  </div>
                  ...
                  <div className='flex gap-2 text-sm '>
                    {CheckmarkIcon}
                    <div>
                      <h5 className='text-xl font-medium mb-1'>Compliance Advisory</h5>
                      <p className='text-[#A7A9AC]'>Guidance to help your business meet basic banking and regulatory requirements.</p>
                    </div>
                  </div>
              ...
              <div className='lg:p-10 p-5 text-white bg-[var(--blue)] rounded-xl grid md:grid-cols-2 gap-6'>
                <div>
                  <h4 className=' text-xl max-w-[360px]'>Need Bank Account Opening Support?</h4>
                <p className='text-sm pt-1'>Call us today for professional banking assistance..</p>
                </div>
                ...
                <li className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    <span className="text-[14px]">Get Banking Support</span>
          ...
          <div className='lg:col-span-1'>
            <div className='max-w-[500px] mx-auto'>
              <ServiceTabs current="/services/corporate-bank-account-support" />
            </div>
          </div>
