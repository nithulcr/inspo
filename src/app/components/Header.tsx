    ...
    return (
        <header className={headerClass}>
            <div className="w-full  bg-[var(--blue)] hidden min-[990px]:block">
                <div className="text-white  border-b border-b-[#dddddd] grid grid-cols-2 items-center  text-sm ">
                    <div className="h-full">
                        <div className="h-full max-w-[660px] flex items-center  space-x-6 top-header-left relative ml-auto px-6 py-2">
                            <p>
                                Ready to grow  your business?
                            </p>
                            <Link href="/ContactUs" className="flex items-center space-x-2 font-bold pr-5">
                                Contact Us
                    ...
                    <div className=" bg-white text-gray-600  h-full">
                        <div className="max-w-[700px] h-full flex items-center  justify-center overflow-hidden gap-5 text-[var(--color)] relative px-6">
                            <div className="items-center justify-center space-x-2 flex relative  py-2 h-full pr-4">
                                ...
                                <span>
                                   Working: 8:00 AM – 6:00 PM (Monday – Friday)
                                </span>
                            </div>
                            <div className="flex flex-row gap-5 relative h-full header-top-social items-center">
            ...
            <div className="bg-white w-full">
                <div className="max-w-[1320px] mx-auto flex items-center justify-between px-6 h-[80px] main-header z-10 relative ">
                    ...
                    <div className="flex items-center gap-4 lg:gap-8 h-full">
                        ...
                        <a className="flex items-center gap-4">
                            ...
                            <div className="hidden lg:block">
                                <h5 className="text-[var(--blue)] font-semibold">+971505614942</h5>
                            </div>
                        </a>
                    </div>
                </div>
            ...
            {open && (
             ...
             <AnimatedButton href="https://wa.me/+971505614942" label="Let's Talk" className="fixed-btn w-fit transparent-btn" imgOrSvg={<img src="/whatsapp.png" alt="Icon" className="w-6" />} />
        </header>
    );
}