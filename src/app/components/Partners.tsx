    ...
    <section className="py-10 lg:py-16 text-[var(--foreground)]">
      <div className="max-w-[1320px] mx-auto px-6 flex  flex-col items-start  gap-5 justify-between mb-10">
        <div className="w-full">
          <h2 className="text-2xl lg:text-[40px] font-medium mb-3 max-w-[560px]">Empowering Success with Inspo&apos;s Expertise.</h2>
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <p className="max-w-[560px] ">

              Our core services are designed to redefine business success. From expert business setup solutions and strategic growth planning to personalized consultancy, we provide a holistic approach tailored to your unique needs.<br /><br />
              With years of industry knowledge, our team ensures seamless processes that save you time, reduce risks, and maximize opportunities. We go beyond standard solutions by offering insights that align with both local regulations and global business trends.<br /><br />
              At Inspo, we believe every business journey is unique. That’s why we focus on building long-term partnerships, delivering measurable results, and supporting you at every stage of growth. Whether you’re an entrepreneur launching your first venture or an established company looking to expand, we are here to turn your vision into lasting success.
