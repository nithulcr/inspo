  ...
  return (
    <>
      <section className="py-14  lg:py-20   mx-auto  ">
        <div className="max-w-[1320px] px-6 mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-20 ">
          {/* Left: Info */}
            ...
            <div className="mb-8">
              ...
              <p>Tell us what support you need, and our team will contact you with the right solution for your business setup, PRO services, tax support, visas, or corporate requirements.</p>
              <ul className="space-y-5 mt-6 lg:mt-10">
                ...
                <li className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    <span className="text-[#8C8C8C] text-sm">Call Us</span>
                    <span className="font-medium text-lg">+971 50 561 4942</span>
                  </div>
                </li>
                <li className="flex items-center gap-4">
                  <span className="bg-[#121212] p-2 rounded-full  w-13 h-13 flex items-center justify-center">
                  ...
                  <div className="flex flex-col gap-1">
                    <span className="text-[#8C8C8C] text-sm">Email Us</span>
                    <span className="font-medium text-lg">info@inspo.ae</span>
                  </div>
                </li>
                <li className="flex items-center gap-4">
                  <span className="bg-[#121212] p-2 rounded-full  w-13 h-13 flex items-center justify-center">
                  ...
                  <div className="flex flex-col gap-1">
                    <span className="text-[#8C8C8C] text-sm">Visit Our Office</span>
                    <span className="font-medium text-lg max-w-md">Sharjah Media City, Al Messaned, Al Bataeh, Sharjah, United Arab Emirates </span>
                  </div>
                </li>
                <li className="flex items-center gap-4">
                  <span className="bg-[#121212] p-2 rounded-full  w-13 h-13 flex items-center justify-center">
                     <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12 2C17.523 2 22 6.477 22 12C22 17.523 17.523 22 12 22C6.477 22 2 17.523 2 12C2 6.477 6.477 2 12 2ZM12 4C9.87827 4 7.84344 4.84285 6.34315 6.34315C4.84285 7.84344 4 9.87827 4 12C4 14.1217 4.84285 16.1566 6.34315 17.6569C7.84344 19.1571 9.87827 20 12 20C14.1217 20 16.1566 19.1571 17.6569 17.6569C19.1571 16.1566 20 14.1217 20 12C20 9.87827 19.1571 7.84344 17.6569 6.34315C16.1566 4.84285 14.1217 4 12 4ZM12 6C12.2449 6.00003 12.4813 6.08996 12.6644 6.25272C12.8474 6.41547 12.9643 6.63975 12.993 6.883L13 7V11.586L15.707 14.293C15.8863 14.473 15.9905 14.7144 15.9982 14.9684C16.006 15.2223 15.9168 15.4697 15.7488 15.6603C15.5807 15.8508 15.3464 15.9703 15.0935 15.9944C14.8406 16.0185 14.588 15.9454 14.387 15.79L14.293 15.707L11.293 12.707C11.1376 12.5514 11.0378 12.349 11.009 12.131L11 12V7C11 6.73478 11.1054 6.48043 11.2929 6.29289C11.4804 6.10536 11.7348 6 12 6Z" fill="#fff" />
                                </svg>


                  </span>
                  <div className="flex flex-col gap-1">
                    <span className="text-[#8C8C8C] text-sm">Business Hours</span>
                    <span className="font-medium text-lg max-w-md">Monday to Saturday: 9:00 AM – 6:00 PM</span>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <form
            ...
            className="rounded-3xl lg:pt-10 space-y-5"
          >
